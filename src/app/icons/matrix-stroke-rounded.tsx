...
const MatrixIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"} {...props}>
    ...
    <path d="M6.99981 8H7.00878M11.9953 8H12.0043M16.9908 8H16.9998M6.99981 12H7.00878M6.99981 16H7.00878M11.9953 12H12.0043M11.9953 16H12.0043M16.9908 12H16.9998M16.9908 16H16.9998" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
